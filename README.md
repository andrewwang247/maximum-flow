...
Run `pytest` to test the flow that is generated on every `resources/network_*.txt` input. All properties of a valid flow are verified and the maximum flow rate is checked against the known solution.
